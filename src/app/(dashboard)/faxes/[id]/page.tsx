        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-6">
          <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
            ...
            <div className="flex gap-3">
              <a href={fax.fileUrl} download={fax.fileName ?? "fax.pdf"}
              ...
              <a href={fax.fileUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 hover:underline">
                Open →
              </a>
            </div>
          </div>
          <iframe src={fax.fileUrl} className="w-full" style={{ height: "70vh" }} title="Fax document preview" />
        </div>
      )}
    </div>
  )
