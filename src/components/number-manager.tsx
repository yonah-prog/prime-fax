        ...
        <div className="bg-white rounded-xl border border-gray-200 px-5 py-4 mb-6 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Faxes are mirrored here, organized into each number&apos;s inbound/outbound folders.</p>
            </div>
          </div>
          {!drive.configured ? (
            <span className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded px-3 py-1.5">Not configured on server</span>
          ) : drive.connected ? (
